...
CREATE INDEX IF NOT EXISTS idx_readme_hnsw
...
-- 중복 수집 방지
CREATE UNIQUE INDEX IF NOT EXISTS uq_community_posts_repo_url
    ON community_posts (repo_id, url);

-- Analyze job: 미분석 게시글 조회
CREATE INDEX IF NOT EXISTS idx_community_posts_unanalyzed
